...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Template tags', type: [String], required: false }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Template active status', required: false }),
    (0, class_validator_1.IsBoolean)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Boolean)
], CreateTemplateDto.prototype, "isActive", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Template HTML', required: false }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], CreateTemplateDto.prototype, "html", void 0);
__decorate([
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Template preview image path', required: false }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
